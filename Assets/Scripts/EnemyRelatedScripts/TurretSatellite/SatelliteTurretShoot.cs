...
public class SatelliteTurretShoot : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (cannonRef.transform.eulerAngles.z == 360)
        {
            cannonRef.transform.localRotation = Quaternion.identity; 
        }
    ...
    Vector2 PlayerDirection()
    {
        ...
        Vector2 playerCannonDistance = new Vector2(playerX - cannonRef.transform.position.x , playerY - cannonRef.transform.position.y);
    ...
    { 
        ...
        bul.transform.rotation = Quaternion.Euler(new Vector3(0, 0, cannonRef.transform.eulerAngles.z));
    ...
    void CalculateDirection()
    {
        ...
        float cannonRotationToRads = Mathf.Deg2Rad* cannonRef.transform.eulerAngles.z; // conver cannon angle to rads
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(cannonRef.transform.position, cannonRef.transform.position + new Vector3(cannonDirection.x, cannonDirection.y, 0f));
    }
